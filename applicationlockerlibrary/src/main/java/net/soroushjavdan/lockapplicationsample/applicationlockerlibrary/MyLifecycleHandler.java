    ...
    public void onActivityStarted(Activity activity) {
        ...
        if(isAppLeaved){
            ...
            if(lockActivityIntent == null ){
                intent = new Intent(activity , LockerActivity.class );
                intent.putExtra(LockerActivity.PASSWORD_EXTRA , password ) ;
                if(enterPassCodeTitle != null){
                    intent.putExtra(LockerActivity.FAIL_PASS_TITLE_EXTRA , wrongPassCodeText ) ;
                    intent.putExtra(LockerActivity.PASS_TITLE_EXTRA , enterPassCodeTitle ) ;
                    intent.putExtra(LockerActivity.SUBMIT_BTN_TEXT , submitButtonText ) ;
                }
            }else{
